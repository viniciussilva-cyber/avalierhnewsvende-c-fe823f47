...
function LeaderLogin() {
  ...
  useEffect(() => {
    if (!loading && leader) navigate({ to: "/profiler/time", replace: true });
      ...
      <PageTransition className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-border bg-background p-8">
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <button
              type="submit"
              className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-sm font-semibold text-primary-foreground transition-transform hover:scale-[1.01] active:scale-95"
            >
