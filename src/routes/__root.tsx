...
export const Route = createRootRouteWithContext<{ queryClient?: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "RH News Hub is a web application for reading and rating internal newsletters." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "RH News Hub is a web application for reading and rating internal newsletters." },
